...
export class migration1612243971920 implements MigrationInterface {
    name = 'migration1612243971920'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("post_id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "post_created" datetime NOT NULL DEFAULT (datetime('now')), "post_updated" datetime NOT NULL DEFAULT (datetime('now')), "post_type" varchar NOT NULL, "post_content" varchar NOT NULL, "post_thumbnail" varchar NOT NULL, "post_comment_count" integer NOT NULL DEFAULT (0), "post_author_id" integer NOT NULL, "post_parent_id" integer, CONSTRAINT "FK_0963adb4683d7297b487bff8d3d" FOREIGN KEY ("post_author_id") REFERENCES "user" ("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_e8bbc13578792bdaca8cfdf8314" FOREIGN KEY ("post_parent_id") REFERENCES "post" ("post_id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
